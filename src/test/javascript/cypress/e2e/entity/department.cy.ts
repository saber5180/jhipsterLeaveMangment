...
describe('Department e2e test', () => {
  ...
  const departmentSample = { name: 'peer' };
  ...
  describe('new Department page', () => {
    ...
    it('should create an instance of Department', () => {
      cy.get(`[data-cy="name"]`).type('indeed worth');
      cy.get(`[data-cy="name"]`).should('have.value', 'indeed worth');

      cy.get(`[data-cy="description"]`).type('curiously act');
      cy.get(`[data-cy="description"]`).should('have.value', 'curiously act');
