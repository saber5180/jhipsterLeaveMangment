...
export const DepartmentDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="leaveManagementv16App.department.delete.question">
        <Translate contentKey="leaveManagementv16App.department.delete.question" interpolate={{ id: departmentEntity.id }}>
