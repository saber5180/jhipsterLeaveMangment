...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './leave.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_LEAVE_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_LEAVE actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_LEAVE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_LEAVE actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_LEAVE actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_LEAVE actions', async () => {
      const arg = 42666;
