...
export const EmployeeDeleteDialog = () => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="leaveManagementv16App.employee.delete.question">
        <Translate contentKey="leaveManagementv16App.employee.delete.question" interpolate={{ id: employeeEntity.id }}>
